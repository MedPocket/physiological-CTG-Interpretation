...
![Nhịp tim cơ bản](../../assets/nhip_co_ban.png)
...
![Dao động nội tại bình thường](../../assets/dao_dong_noi_tai_binh_thuong.png)

- **Giảm dao động:** Biên độ dải dưới 5 bpm kéo dài trên 50 phút ở đoạn nhịp cơ bản, hoặc trên 3 phút trong các nhịp giảm.

![Dao động nội tại giảm](../../assets/dao_dong_noi_tai_giam.png)
...
![Kiểu nhảy (Saltatory)](../../assets/kieu_nhay.png)
...
![Kiểu hình sin (Sinusoidal)](../../assets/kieu_hinh_sin.png)
...
![Kiểu giả hình sin](../../assets/kieu_gia_hinh_sin.png)
...
![Nhịp tăng (Acceleration)](../../assets/nhip_tang.png)
...
![Nhịp giảm sớm (Early decel.)](../../assets/nhip_giam_som.png)
...
![Nhịp giảm biến đổi (Variable)](../../assets/nhip_giam_bien_doi.png)
...
![Nhịp giảm muộn (Late decel.)](../../assets/nhip_giam_muon.png)
...
![Nhịp giảm kéo dài (Prolonged)](../../assets/nhip_giam_keo_dai.png)
...
![Quy tắc 3 phút](../../assets/quy_tac_3_phut.png)
