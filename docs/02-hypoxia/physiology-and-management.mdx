...
![Sinh lý của tình trạng thiếu oxy](../assets/sinh_ly_thieu_oxy.png)
...
![Thiếu oxy bán cấp](../assets/thieu_oxy_ban_cap.png)
...
1. **Giai đoạn 1-3 (Stress thiếu oxy):** Xuất hiện các nhịp giảm (bằng chứng của stress thiếu oxy), mất các nhịp tăng và mất chu kỳ hoạt động/ngủ của thai, nhịp giảm trở nên rộng hơn và sâu hơn (đáp ứng quá mức).

![Nhịp giảm trong thiếu oxy tiến triển](../assets/nhip_giam_tien_trien.png)

2. **Giai đoạn 4 (Tái phân bố tuần hoàn):** **Tăng nhịp tim cơ bản** do tăng tiết catecholamin để tái phân bố tuần hoàn.

![Tăng nhịp tim cơ bản](../assets/tang_nhip_co_ban.png)

3. **Giai đoạn 5 (Mất bù):** **Giảm dao động nội tại** do não bắt đầu bị ảnh hưởng bởi tình trạng toan hóa.

![Dao động nội tại giảm trong thiếu oxy tiến triển](../assets/dao_dong_noi_tai_giam_tien_trien.png)

4. **Giai đoạn 6 (Suy tim giai đoạn cuối):** Suy tim giai đoạn cuối (nhịp cơ bản không ổn định, tụt dần theo "kiểu hình bậc thang dẫn đến tử vong").
...
![Thiếu oxy mạn tính](../assets/thieu_oxy_man.png)
